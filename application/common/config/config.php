...
$_config = [
    ...
    'view_replace_str'       => array(
        ...
        '__ADMIN_IMG__'  => __ROOT__ . '/' . APP_DIR . 'admin/view/public/img',
        '__ADMIN_CSS__'  => __ROOT__ . '/' . APP_DIR . 'admin/view/public/css',
        '__ADMIN_JS__'   => __ROOT__ . '/' . APP_DIR . 'admin/view/public/js',
        '__ADMIN_LIBS__' => __ROOT__ . '/' . APP_DIR . 'admin/view/public/libs',
        '__HOME_IMG__'   => __ROOT__ . '/' . APP_DIR . 'home/view/public/img',
        '__HOME_CSS__'   => __ROOT__ . '/' . APP_DIR . 'home/view/public/css',
        '__HOME_JS__'    => __ROOT__ . '/' . APP_DIR . 'home/view/public/js',
        '__HOME_LIBS__'  => __ROOT__ . '/' . APP_DIR . 'home/view/public/libs',
    ),
    // 默认跳转页面对应的模板文件
